const en: Record<string, string> = {
  ...
  "modal.panelBypassLabel": "Start supported agents in bypass mode",
  "modal.panelBypassWarning": "Claude/Codex/OpenCode may skip permission prompts; Codex also disables its sandbox. Disable this for safer prompts.",
  ...
  "consent.description": "The selected team configuration requires Communication Adapter verification or updates for Agent Intercom cross-pane collaboration.",
  "consent.actionInstall": "Install adapter & create",
  "consent.actionWithout": "Create without installing",
  "consent.actionCancel": "Cancel",
  "consent.installing": "Installing adapters...",
  "consent.license": "License: {license}",
  "consent.networkRequired": "Network required (download)",
  "consent.offlineBundle": "Bundled offline",
  "consent.source.bundled": "Bundled offline asset",
  "consent.source.npmRegistry": "npm: {pkg}",
  "consent.source.piGit": "Official Pi package repository",
  "consent.source.existingGlobal": "Existing global installation",
  "consent.source.unknown": "Unknown source",
  "consent.adapterChanges_one": "{n} adapter change",
  "consent.adapterChanges_other": "{n} adapter changes",
  "consent.config.none": "Host config untouched",
  "consent.config.appPrivate": "App-private managed config",
  "consent.config.hostRegistered": "Registers in host config",
  "consent.targetVersion": "Target: v{version}",
  "consent.installedVersion": "Installed: v{version}",
  "consent.actionReason.install": "Install {version}",
  "consent.actionReason.upgrade": "Upgrade to {version}",
  "consent.actionReason.repair": "Repair {version}",
  "consent.actionReason.manualMigration": "Manual migration required",
  "consent.manualMigrationHint": "Automated migration is deferred. Please remove the legacy adapter package manually before continuing.",
  "consent.securityGuarantee": "Staged isolation: Installation failures roll back safely without removing existing healthy adapters.",
  "consent.disabledInstall": "Installation cannot proceed because one or more adapters require manual migration.",
  "consent.disabledCreateWithout": "Cannot create without installing because an incompatible legacy adapter is active and cannot be safely bypassed.",
  "consent.allHealthy": "All communication adapters are verified and healthy.",

  // Team Lead & Roles
  "modal.leadBadge": "Lead (Pane 1)",
  "modal.leadDesignate": "Lead",
  "modal.makeLead": "Set as Lead",
  "modal.leadHint": "Pane 1 orchestrates the team as Lead. Reassigning moves the selected agent to Pane 1.",
  "modal.leadUpdatedAria": "Lead agent set to {agent} on Pane 1",
  "modal.roleLead": "Lead",
  "modal.roleWorker": "Coworker",
  "modal.teamMode": "Team Mode (Intercom)",
  "modal.standaloneMode": "Standalone (No Intercom)",
  "status.layer.process": "Process",
  "status.layer.adapter": "Adapter",
  "status.layer.intercom": "Intercom",
  "status.layer.team": "Team",
  ...
  "panel.today": "Today",
  "panel.last30d": "30 days",
  "panel.collecting": "Collecting...",
  "panel.updatedAt": "Updated {time}",
  "panel.justNow": "just now",
  "panel.minutesAgo": "{n}m ago",
  "panel.hoursAgo": "{n}h ago",
  "panel.notDetected": "Not detected",
  "panel.sessions_one": "{n} session",
  "panel.sessions_other": "{n} sessions",
  "panel.workspaces": "Workspaces",
  "panel.noWorkspaces": "No active workspaces",
  "panel.panes_one": "{n} pane",
  "panel.panes_other": "{n} panes",
  "panel.running": "Running",
  "panel.idle": "Idle",
  "panel.addPane": "Add pane",
  "panel.mobileConnected_one": "Mobile: {n} client",
  ...
  "ERR_KILL_LEAD_NOT_ALLOWED": "Cannot terminate the Lead pane while the team workspace is active",
  "ERR_LEAD_DISCONNECTED": "The Team Lead pane has terminated or disconnected. Team modifications are blocked.",
  "ERR_PLAN_STALE": "The install plan is stale due to environment changes. Please recheck and try again.",
  "ERR_PLAN_INVALID": "The install plan is invalid or cannot be applied in the current state.",
  "ERR_ADAPTER_UNAVAILABLE": "Communication adapter is unavailable on this platform or host CLI is missing.",
  "ERR_ADAPTER_INSTALL": "Failed to install Communication Adapter.",
  "ERR_ADAPTER_VERIFY": "Communication adapter verification failed.",
  "ERR_ADAPTER_CONFIG": "Failed to configure host for communication adapter.",
  "ERR_ADAPTER_ROLLBACK": "Failed to rollback communication adapter installation.",
  "ERR_ADAPTER_INSTALL_FAILED": "Failed to install Communication Adapter",
  "ERR_ADAPTER_NOT_FOUND": "Communication adapter not found",
  "ERR_ADAPTER_INCOMPATIBLE_NS": "Incompatible legacy adapter namespace detected. Please migrate before continuing.",
  ...
  "val.saveConfigFailed": "Failed to save settings",
...
const zh: Record<string, string> = {
  ...
  "modal.agentMixItem": "{agent} ×{n}",
  "modal.agentMixSeparator": " · ",
  "modal.panelBypassLabel": "以自动绕过模式启动支持的 Agent",
  "modal.panelBypassWarning": "Claude/Codex/OpenCode 可能跳过权限提示；Codex 还会关闭 sandbox。为更安全的提示模式请关闭此项。",
  ...
  "consent.description": "所选团队配置涉及通信适配器确认或更新，以支持 Agent Intercom 跨 Pane 协作。",
  "consent.actionInstall": "安装适配器并创建",
  "consent.actionWithout": "不安装直接创建",
  "consent.actionCancel": "取消",
  "consent.installing": "正在安装适配器...",
  "consent.license": "许可证: {license}",
  "consent.networkRequired": "需要网络下载",
  "consent.offlineBundle": "内置离线包",
  "consent.source.bundled": "内置离线资源",
  "consent.source.npmRegistry": "npm 包: {pkg}",
  "consent.source.piGit": "Pi 官方扩展源",
  "consent.source.existingGlobal": "已有的全局安装",
  "consent.source.unknown": "未知来源",
  "consent.adapterChanges_one": "{n} 项适配器变更",
  "consent.adapterChanges_other": "{n} 项适配器变更",
  "consent.config.none": "宿主配置保持不变",
  "consent.config.appPrivate": "应用私有托管配置",
  "consent.config.hostRegistered": "注册至宿主配置文件",
  "consent.targetVersion": "目标版本: v{version}",
  "consent.installedVersion": "已安装版本: v{version}",
  "consent.actionReason.install": "安装 {version}",
  "consent.actionReason.upgrade": "升级至 {version}",
  "consent.actionReason.repair": "修复 {version}",
  "consent.actionReason.manualMigration": "需手动清理迁移",
  "consent.manualMigrationHint": "自动迁移功能已延期。请在继续前手动移除旧版适配器包。",
  "consent.securityGuarantee": "分阶段安全隔离：安装失败将安全回滚临时文件，不影响已就绪的健康适配器。",
  "consent.disabledInstall": "无法继续安装：存在需要手动迁移的适配器。",
  "consent.disabledCreateWithout": "无法跳过安装：检测到冲突的旧版适配器且无法安全忽略。",
  "consent.allHealthy": "所有通信适配器均已验证且状态健康。",

  // Team Lead & Roles
  "modal.leadBadge": "主导 (Pane 1)",
  "modal.leadDesignate": "主导",
  "modal.makeLead": "设为主导",
  "modal.leadHint": "Pane 1 作为 Lead 协调团队。重新指定会将所选 Agent 调整至 Pane 1。",
  "modal.leadUpdatedAria": "已将 Pane 1 主导 Agent 设置为 {agent}",
  "modal.roleLead": "主导",
  "modal.roleWorker": "协作者",
  "modal.teamMode": "团队模式 (Intercom)",
  "modal.standaloneMode": "独立运行 (无 Intercom)",
  "status.layer.process": "进程",
  "status.layer.adapter": "适配器",
  "status.layer.intercom": "通信",
  "status.layer.team": "团队",
  ...
  // Tray Panel
  "panel.usageTitle": "Token 消耗",
  "panel.today": "今日",
  "panel.last30d": "近 30 天",
  "panel.collecting": "统计中…",
  "panel.updatedAt": "更新于{time}",
  "panel.justNow": "刚刚",
  "panel.minutesAgo": "{n} 分钟前",
  "panel.hoursAgo": "{n} 小时前",
  "panel.notDetected": "未检测到",
  "panel.sessions_one": "{n} 个会话",
  "panel.sessions_other": "{n} 个会话",
  "panel.workspaces": "工作区",
  "panel.noWorkspaces": "暂无活动工作区",
  "panel.panes_one": "{n} 个分屏",
  "panel.panes_other": "{n} 个分屏",
  "panel.running": "运行中",
  "panel.idle": "空闲",
  "panel.addPane": "新增分屏",
  "panel.mobileConnected_one": "手机端：{n} 个连接",
  ...
  "ERR_KILL_LEAD_NOT_ALLOWED": "工作区处于活跃状态时无法单独终止 Lead 分屏",
  "ERR_LEAD_DISCONNECTED": "Team Lead 分屏已终止或断开连接，已锁定团队变更。",
  "ERR_PLAN_STALE": "安装计划已过期（本地环境发生变动）。请重新检查后再试。",
  "ERR_PLAN_INVALID": "安装计划无效或当前状态下不可执行。",
  "ERR_ADAPTER_UNAVAILABLE": "当前平台不支持该通信适配器或缺少宿主 CLI 程序。",
  "ERR_ADAPTER_INSTALL": "通信适配器安装失败。",
  "ERR_ADAPTER_VERIFY": "通信适配器校验失败。",
  "ERR_ADAPTER_CONFIG": "配置通信适配器宿主失败。",
  "ERR_ADAPTER_ROLLBACK": "通信适配器安装回滚失败。",
  "ERR_ADAPTER_INSTALL_FAILED": "通信适配器安装失败",
  "ERR_ADAPTER_NOT_FOUND": "未找到指定的通信适配器",
  "ERR_ADAPTER_INCOMPATIBLE_NS": "检测到不兼容的旧版适配器命名空间，请先清理迁移后再继续。",
