...
export function NewWorkspaceCard({ onClick }: NewWorkspaceCardProps) {
  return (
    <div
      onClick={onClick}
      className="flex flex-col items-center justify-center min-h-[14rem] rounded-2xl border-2 border-dashed border-white/20 bg-slate-900/[0.62] hover:bg-slate-800/[0.72] hover:border-cyan-400/50 transition-colors duration-200 cursor-pointer group shadow-lg shadow-black/10 animate-fade-in-up"
    >
